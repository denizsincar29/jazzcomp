...
#
# print(f"Generated comping with {len(comping_voicings)} voicings.") # Comping disabled
...
# if comping_stream.hasMeasures(): # music21 might create empty streams otherwise # Comping disabled
...
# else:
#     # This print might be misleading if comping_stream is not defined.
#     # print("Comping stream is empty or invalid, skipping XML/WAV generation.") # Comping disabled
#     pass # comping_stream would not be defined if the above block is commented.
...
# if os.path.exists('test_comping_line.wav'): # Comping disabled
...
# else:
#     print("Comping WAV file not found, skipping its addition to the mix.") # Comping disabled
